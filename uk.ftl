...
features-images-title = Завершіть картину
...
features-colours-title = Налаштуйте кольори правильно
features-colours = Ви мислите графічно? Ви запам'ятовуєте за допомогою розташування та кольору? Що ж, переконайтеся, що ви вибрали правильні кольори для ваших тем, просто натисніть на гілку, щоб викликати колірне колесо і виберіть колір, який хочете.
...
help-searchcoggle = Введіть запит, щоб знайти документи &mdash; легко шукайте будь-яке слово в діаграмі!
...
summary-overdue-plan = Ваша передплата неактивна через прострочений платеж. Ви можете виправити це, оновивши дані про картку або зв'язавшись з нами на <b>hello@coggle.it</b>.
...
me-language-questions = Якщо у вас є питання щодо перекладу – або ви хочете запропонувати поправки та покращення, але не впевнені, що знаєте як, напишіть нам на <a data-l10n-name='translate-email'>translate@coggle.it</a>.
...
me-as-awesome-orgmember-p1 = Це ваше &mdash; ви дивитеся Coggle як <b>член організації</b>.
...
faq-orgs-edu-a = Так! Напишіть нам на education@coggle.it, щоб дізнатися більше.

faq-orgs-more-q = У мене залишилися питання...
faq-orgs-more-a = Запитай нас! Надішліть повідомлення на orgs@coggle.it, і ми будемо раді допомогти :)
...
about-getintouch =
  ...
  </a>, також ви завжди можете надіслати листа на <a data-l10n-name="email">hello@coggle.it </a>— Ми любимо спілкуватися!
