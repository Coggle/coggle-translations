...
switch-yearly = Палепшыць да штогадовай
...
search-diagrams =
    .placeholder = Шукаць у сваіх дыяграмах
search-public-diagrams = 
    .placeholder = Шукаць у публічных дыяграмах
...
diagrams-unlimited = <span data-l10n-name="count">Неабм. кол-ць</span> прыватн. дыяграм
...
doclist-shared = <b>Абагуленае з вамі</b> — дыяграмы, створаныя іншымі і абагуленыя з вамі, адлюстроўваюцца тут.
...
summary-uy-1 = Атрымайце два месяцы бясплатна (<b>зэканомце 15%</b>) пры гадавой аплаце. <a data-l10n-name="upgrade">Палепшыць (<b>$50</b>)</a>
...
me-emailstip = Электронныя лісты будуць адпраўляцца толькі на асноўны адрас, але вы можаце атрымліваць запрашэнні на любы з астатніх.
...
invite-n-more =
    { $introduceCount ->
           ...
           [few] Запрасіце яшчэ <span>{$introduceCount}</span> чалавекі, каб паспрабаваць Awesome бясплатна!
...
recommend-share-link = Запрасіце супрацоўнікаў або падзяліцеся сваёй рэферальнай спасылкай па <a data-l10n-name='email'>эл. пошце</a>.
...
sc-alt = alt
sc-option = option ⌥
sc-dragdrop = перацягн. і адпусціць
...
sidebar-sc-parent = Перайсці да бацькоўскага:
...
sidebar-bgmenu = Каб <b>змяніць маштаб</b>, <b>адрабіць змены</b> і <b>ўставіць скапіяваныя элементы</b>, націсніце правай кнопкай па фоне.
sidebar-bgmenu2 = Каб <b>змяніць маштаб</b>, дадаць <b>тэкставыя меткі</b>, <b>адрабіць змены</b> і <b>ўставіць скапіяваныя элементы</b>, націсніце правай кнопкай па фоне.
...
button-resize =
    .title = Перацягвайце, каб змяніць памер тэксту
label-fontsize = Памер шрыфту <span data-l10n-name="fontsize"></span>px.

hint-toolong = Элемент занадта доўгі! Паспрабуйце перанесці частку тэксту ў новы элемент: абярыце тэкст і націсніце <kb-key data-l10n-name="tab-key">tab</kb-key>
hint-movetext = Паспрабуйце перанесці частку тэксту ў новы элемент: абярыце тэкст і націсніце <kb-key data-l10n-name="tab-key">tab</kb-key>
...
about-hello2-p2 =
    ...
    будзем клапаціцца пра вашы даныя найлепшым чынам, рабіць рэзервовыя
...
about-share =
  ...
  спісаў, табліц і традыцыйных дакументаў! Вы можаце абагуліць Coggle
  <a data-l10n-name="x">ў X</a> або <a data-l10n-name="facebook">на Facebook</a>.

about-itp-title = Вы — з прэсы?
...
fact-shortcuts-1 = Ці ведалі вы, што можна рэдагаваць Coggle толькі з дапамогай клавіятуры? Можна, вось як:<br>[tab] для дадавання даччынага вузла<br>[shift]+[tab] для пераходу да бацькоўскага<br>[shift]+[return] для дадавання вузла на тым жа ўзроўні
